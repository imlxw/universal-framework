package com.microservices.wechat.controller;
...
import com.microservices.wechat.WechatApis;
import com.microservices.wechat.interceptor.WechatApiConfigInterceptor;
import com.microservices.wechat.interceptor.WechatUserInterceptor;

@Before({ WechatApiConfigInterceptor.class, WechatUserInterceptor.class })
public abstract class MicroservicesWechatController extends MicroservicesController {

	public static final String SESSION_WECHAT_OPEN_ID = "_microservices_wechat_open_id_";
	public static final String SESSION_WECHAT_ACCESS_TOKEN = "_microservices_wechat_access_token_";
	public static final String SESSION_WECHAT_SCOPE = "_microservices_wechat_scope_";
	public static final String SESSION_WECHAT_USER_JSON = "_microservices_wechat_json_";
	public static final String ATTR_USER_OBJECT = "_microservices_user_object_";
	...
	public void wechatCallback() {
		...
		if (StringUtils.isNotBlank(wechatOpenId) && StringUtils.isNotBlank(accessToken)) {
	...
	private void doRedirect(String gotoUrl, String wechatOpenId, String accessToken) {
		...
		/**
		 * 由于 wechatOpenId 或者 accessToken 是可能从session读取的， 从而导致失效等问题
		 */
	...
	public void doNotAlloVisitRedirect() {
		/**
		 * 一般情况下，此方法是为了调整到其他页面，比如让用户扫描二维码之类的 由子类去实现
		 */
		renderText("microservices wechat error, cannot visit in this browser.");
	}
	 ...
	 * <p>
	 * <p>
	 * apiResult内如如下： { "subscribe": 1, "openid": "o6_bmjrPTlm6_2sgVt7hMZOPfL2M", "nickname": "Band", "sex": 1, "language": "zh_CN", "city": "广州", "province": "广东", "country": "中国", "headimgurl":
	 * "http://wx.qlogo.cn/mmopen/g3MonUZtNHkdmzicIlibx6iaFqAc56vxLSUfpb6n5WKSYVY0ChQKkiaJSgQ1dZuTOgvLLrhJbERQQ4 eMsv84eavHiaiceqxibJxCfHe/0", "subscribe_time": 1382694957, "unionid": " o6_bmasdasdsad6_2sgVt7hMZOPfL" "remark": "",
