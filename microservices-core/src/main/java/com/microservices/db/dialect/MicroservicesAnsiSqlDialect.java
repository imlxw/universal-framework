...
public class MicroservicesAnsiSqlDialect extends AnsiSqlDialect implements IMicroservicesModelDialect {
	...
	public String forFindByColumns(String table, String loadColumns, List<Column> columns, String orderBy, Object limit) {
		...
		if (limit != null) {
			throw new MicroservicesException("limit param not finished MicroservicesAnsiSqlDialect.");
		}
