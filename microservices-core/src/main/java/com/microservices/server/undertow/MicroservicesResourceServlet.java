...
/**
 * 改写：DefaultServlet，DefaultServlet有后缀大小写敏感的问题， 例如：输入 xxx.jar 无法下载，但是输入xxx.JAR却能下载
 */
public class MicroservicesResourceServlet extends HttpServlet {
	...
	private static final Set<String> DEFAULT_ALLOWED_EXTENSIONS = Collections
			.unmodifiableSet(new HashSet<>(Arrays.asList("js", "css", "png", "jpg", "gif", "html", "htm", "txt", "pdf", "jpeg", "xml", "otf", "eot", "svg", "ttf", "woff", "woff2")));
