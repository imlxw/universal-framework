...
public class ClassScanner {
	...
	private static boolean isExcluedeJar(Manifest manifest) {
		...
		if (exportPackage != null) {
			if (exportPackage.startsWith("com.google.") || exportPackage.startsWith("org.apache.") || exportPackage.startsWith("org.jboss.") || exportPackage.startsWith("com.netflix.") || exportPackage.startsWith("com.github.")
					|| exportPackage.startsWith("org.eclipse.") || exportPackage.startsWith("com.fasterxml.") || exportPackage.startsWith("org.slf4j") || exportPackage.startsWith("net.sf")) {
				return true;
			}
		}
		...
		if (vendor != null) {
			...
			if (vendor.indexOf("jboss") > -1 || vendor.indexOf("apache") > -1 || vendor.indexOf("oracle") > -1 || vendor.indexOf("netty") > -1 || vendor.indexOf("dubbo") > -1) {
				return true;
			}
		}
