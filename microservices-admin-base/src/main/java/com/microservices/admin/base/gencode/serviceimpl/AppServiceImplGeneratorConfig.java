 ...
 * api代码生成配置
 */
@PropertyConfig(prefix = "microservices.admin.serviceimpl.ge")
public class AppServiceImplGeneratorConfig {
	...
	public String toString() {
		return "AppServiceImplGeneratorConfig{" + "modelpackage='" + modelpackage + '\'' + ", servicepackage='" + servicepackage + '\'' + ", serviceimplpackage='" + serviceimplpackage + '\'' + ", removedtablenameprefixes='"
				+ removedtablenameprefixes + '\'' + ", excludedtable='" + excludedtable + '\'' + ", excludedtableprefixes='" + excludedtableprefixes + '\'' + '}';
	}
}
