package com.microservices.admin.base.plugin.shiro;
...
public class RetryLimitHashedCredentialsMatcher extends HashedCredentialsMatcher {
	...
	public boolean doCredentialsMatch(AuthenticationToken _token, AuthenticationInfo info) {
		...
		AtomicInteger atomicInteger = Microservices.me().getCache().get(CacheKey.CACHE_SHIRO_PASSWORDRETRY, username);
		...
		Microservices.me().getCache().put(CacheKey.CACHE_SHIRO_PASSWORDRETRY, username, atomicInteger, lockedSeconds);
		...
		if (matches) {
			Microservices.me().getCache().remove(CacheKey.CACHE_SHIRO_PASSWORDRETRY, username);
		}
