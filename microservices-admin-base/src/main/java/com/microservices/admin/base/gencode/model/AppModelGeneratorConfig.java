 ...
 * model代码生成配置
 */
@PropertyConfig(prefix = "microservices.admin.model.ge")
public class AppModelGeneratorConfig {
	...
	public String toString() {
		return "AppGeneratorConfig{" + "modelpackage='" + modelpackage + '\'' + ", removedtablenameprefixes='" + removedtablenameprefixes + '\'' + ", excludedtable='" + excludedtable + '\'' + ", excludedtableprefixes='"
				+ excludedtableprefixes + '\'' + '}';
	}
}
