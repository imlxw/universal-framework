 ...
 * api代码生成配置
 */
@PropertyConfig(prefix = "microservices.admin.service.ge")
public class AppServiceGeneratorConfig {
	...
	public String toString() {
		return "AppServiceGeneratorConfig{" + "modelpackage='" + modelpackage + '\'' + ", servicepackage='" + servicepackage + '\'' + ", removedtablenameprefixes='" + removedtablenameprefixes + '\'' + ", excludedtable='" + excludedtable
